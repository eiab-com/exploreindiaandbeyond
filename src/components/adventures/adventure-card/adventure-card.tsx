...
const AdventureCard = ({
  ...
  return (
    <Card className="bg-card group w-full max-w-full xs:max-w-xs sm:max-w-sm md:max-w-md rounded-md overflow-hidden  shadow-sm hover:shadow-xl transition-all duration-300 border-primary/10 flex flex-col h-fit">
